...
PoseStamped interpolatePose(const PoseStamped &pose_a,
                            const PoseStamped &pose_b, const double time_stamp, const bool mod_keep_2D);
...
public:
  ...
  PoseStamped getInterpolatePoseStamped(const double time_stamp, const bool mod_keep_2D) const;
  PoseStamped getCurrentPoseStamped() const;
  PoseStamped getPrevPoseStamped() const;
  Velocity getVelocity(const bool mod_keep_2D) const;
